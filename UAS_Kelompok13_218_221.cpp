...
void header() {
    cout << "====================================================\n";
    cout << "        UAS STRUKTUR DATA - BST & AVL TREE           \n";
    cout << "        Studi Kasus : Sistem Registrasi KRS          \n";
    cout << "----------------------------------------------------\n";
    cout << "Kelompok 13\n";
    cout << "1. Zuyyina Aaliyah Fati - 24081010218\n";
    cout << "2. Maya Aksa Fibellanindy - 24081010221\n";
    cout << "====================================================\n";
}
...
void exportToTxt(Node* root, bool avl) {
    ...
    file << "Height : " << hitungHeight(root) << endl;
